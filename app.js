...
defaulturl = "https://api.openweathermap.org/data/2.5/onecall?lat=28.6517178&lon=77.2219388&units=metric&exclude=hourly,minutely&appid=52d5be48feb2b9f52e68e625ffeb8f0b";
...
app.post('/',(req,res)=>{
    ...
    const Cityurl = "https://api.openweathermap.org/geo/1.0/direct?q="+CityName+"&limit=5&appid=52d5be48feb2b9f52e68e625ffeb8f0b";
    https.get(Cityurl,(response)=>{
        response.on("data",(data)=>{
            ...
            const url = "https://api.openweathermap.org/data/2.5/onecall?lat="+lat+"&lon="+lon+"&units=metric&exclude=hourly,minutely&appid=52d5be48feb2b9f52e68e625ffeb8f0b"
